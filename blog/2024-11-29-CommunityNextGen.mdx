...
authors: arpita
tags: [Blog, Monthly Update, CIROH, National Water Model, NextGen Datastream, Singularity, HPC, TEEHR, Hydrofabric]
...
We're excited to announce a comprehensive new end-to-end workflow video tutorial for NGIAB! This resource walks users through the entire process, making it easier than ever to get started with NextGen modeling. The tutorial is available in our [documentation](/docs/products/ngiab/ngiab-intro) and provides step-by-step guidance for both new and experienced users.
