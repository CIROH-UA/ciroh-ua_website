...
<div className="presentation-container">
  ...
  <div className="presentation-resources">
    <span>Slides are available here:</span>
    <a href="/files/DevCon25-PlenaryKeyNote-Arpita-Dan.pdf" className="slides-link">
      View slideshow
    </a>
  </div>
</div>
...
It’s an exciting time for CIROH community, and we’re thrilled to be a part of this
dynamic community!
