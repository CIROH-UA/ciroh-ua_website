...
We're thrilled to announce that **NextGen In A Box (NGIAB)** has surpassed **10,000 Docker pulls** — a significant milestone reflecting the growing adoption of water modeling tools that are accessible to all. This achievement underscores the impact of making advanced water prediction capabilities available to researchers, practitioners, and students worldwide.
...
Behind this number are stories of:
 ...
 🌍 **International collaborators** contributing to water modelling advancement without infrastructure constraints 
