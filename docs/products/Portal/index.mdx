...
- ☁️ [Amazon AWS](https://aws.amazon.com/) - Cloud hosting infrastructure
...
|------------|-------------|
| <https://github.com/CIROH-UA/ciroh-portal> | Docusaurus site and general portal configuration |
| <https://github.com/CIROH-UA/tethysportal-ciroh> | Tethys deployment with all native apps |
