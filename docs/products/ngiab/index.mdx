      ...
      <tbody>
        <tr>
          <th>
            ...
            <p style={{'margin':'0'}}>(<Link to="/docs/products/ngiab/distributions/ngiab-docker/">Cloud</Link>, <Link to="/docs/products/distributions/ngiab-singularity/">HPC</Link>)</p>
          </th>
          <td>
        ...
        <tr>
          <th><Link to="/docs/products/ngiab/extenstions/nextgen-datastream/">DataStreamCLI</Link></th>
          <td>
