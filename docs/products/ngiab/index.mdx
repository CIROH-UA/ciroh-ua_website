...
<Link class="button button--active button--primary" style={{'margin-right':'1.3rem','margin-bottom':'1.3rem'}} to="/docs/products/ngiab/ngiab-intro/workflow">Get started with NGIAB on local machine</Link>

<Link class="button button--active button--primary" style={{'margin-right':'1.3rem','margin-bottom':'1.3rem'}} to="/docs/products/ngiab/ngiab-intro/workflow-cloud">Get started with NGIAB using CIROH JupyterHub</Link>
  ...
  <TabItem value="features" label="Key Features" default>
    <table>
      ...
      <tbody>
        ...
        <tr>
          <th><Link to="/docs/products/ngiab/extensions/nextgen-datastream/">DataStreamCLI</Link></th>
          <td>
