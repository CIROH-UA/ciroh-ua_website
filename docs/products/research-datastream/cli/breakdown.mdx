...
If you're looking for a guide for how to run the script, run `scripts/datastream-guide` after [installation](/docs/products/research-datastream/cli/install) for an interactive tutorial.
