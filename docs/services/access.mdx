...
> **Note**: If using CIROH-2i2c services, please see the "Accessing CIROH JupyterHub" section below for additional steps.
...
PIs or Workshop Leads leading CIROH projects or workshops may use this form to request cloud computing resources (AWS, Google Cloud, CIROH-2i2c JupyterHub). Access is available to all consortium members and partners.
